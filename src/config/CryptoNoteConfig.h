...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const char     GENESIS_COINBASE_TX_HEX[] = "012801ff00018080ed81d8bcf811024c0ad4c9fe838eb4ae1d554522abe5ec6690caa8e75f7a0b16de7fc0a04981872101a2eba55d3fc747c176fcb59b43954ec18170e4a1bf98fce80940b1ee72e7fe91";
        ...
        const uint64_t DEFAULT_MIXIN_V1                        =                                      4;
        const uint64_t DEFAULT_MIXIN_V2                        =                                      4;
        ...
        const size_t   DIFFICULTY_WINDOW_V1                    =                                  2'000;
        ...
        const uint32_t UPGRADE_HEIGHT_V3                    =             2; // Upgrade height for CN-Lite Variant 1 switch.
        const uint32_t UPGRADE_HEIGHT_V4                    =             3; // Upgrade height for CN-Dark Lite Variant 1 switch.
    ...
    const char     CRYPTONOTE_NAME[]           =           "SpexyCoin";
    const char     DATADIR_NAME[]              =           "SpexyCoin";
    ...
    const std::unordered_map<uint8_t, std::function<void(const void *data, size_t length, Crypto::Hash &hash) >> HASHING_ALGORITHMS_BY_BLOCK_VERSION = {
        ...
        { BLOCK_MAJOR_VERSION_4, Crypto::cn_dark_lite_slow_hash_v1   }, /* UPGRADE_HEIGHT_V4 */
