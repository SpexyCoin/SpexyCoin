...
namespace WalletConfig
{
    ...
    const std::string daemonName = "SpexyCoinDaemon";

    /* The name to call this wallet */
    const std::string walletName = "SpexyCoinWallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "SpexyCoinService-deprecated";
    ...
    const size_t saveWalletEveryNBlocks = 2'500;
} // namespace WalletConfig
